...
plt.gca().annotate('Gorham 2008', color='red', xy=(200, res['mean'][-1]), xytext=(200, res['mean'][-1]/10),                                                         
                   arrowprops=dict(facecolor='red', edgecolor='red', shrink=0.1), fontsize=20, horizontalalignment='right',
                   )   
plt.gca().annotate('Al Samarai 2016', color='red', xy=(1, res['mean'][0]), xytext=(1, 10*res['mean'][0]),                                                         
                   arrowprops=dict(facecolor='red', edgecolor='red', shrink=0.1), fontsize=20, horizontalalignment='left',
                   )   
plt.grid('on')
plt.ylim(0.1,20)
plt.show()
